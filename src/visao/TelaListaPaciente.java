...
public class TelaListaPaciente extends JFrame {
	...
	public TelaListaPaciente() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaListaPaciente.class.getResource("/visao/logoHospital.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(TelaListaPaciente.class.getResource("/visao/iconPesquisa.png")));
